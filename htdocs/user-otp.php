        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form method="post" class="login100-form">
                    <span class="login100-form-title"> OTP Verify </span>
                    ...
                    <div class="wrap-input100">
                        <input class="input100" type="number" id="otp" name="otp" placeholder="OTP" />
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="container-login100-form-btn">
                         <button type="submit" name="check" class="login100-form-btn">Verify</button>
                    </div>
                    <div class="message">
                        <p align="center">
                            <span class="message">
